...
<head>
    ...
    <title>BabyCare - Reset Password</title>
</head>
<body style="background:#f9fcff; font-family: montserrat; ">
    ...
    <p>Kami telah mengetahui bahwa anda memberi permintaan untuk melakukan reset password di aplikasi kami. Untuk melakukan reset password gunakanlah One Time Password (OTP) berikut.</p>
